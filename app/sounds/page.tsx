                    ...
                    <div className='flex justify-center items-start h-full'>
                        ...
                        <div className='flex flex-col justify-start items-start w-[65%] rounded-xl'>
                            <div className="h-64 w-full relative rounded-xl">
                                <Image
                                    src="/images/forms/sound-hero.jpg"
                                ...
                                />
                                    ...
                                    <h1 className="text-3xl font-bold">Book Sound Systems for Your Event</h1>
                                    <p className="text-sm mt-2">Fill out the form on the right side to schedule your special occasion</p>
                                </div>
                            </div>

                            <div className='flex flex-col justify-center items-start mt-4'>
                                <h2 className='font-bold mb-4 text-xl'>Venus - Sound System Services</h2>
                                <p className='text-gray-500 mb-2'>Ensure crystal-clear sound and unforgettable audio experiences with VENUS TENT LIGHT AND SOUND’s professional sound services. Whether you’re hosting a wedding, party, corporate event, or live performance, our high-quality sound systems are designed to meet the unique needs of your event, delivering powerful and seamless audio coverage.</p>
                                <p className='text-gray-500 mb-2'>Serving Ranchi, Ramgarh, and surrounding areas, we offer advanced sound equipment, including microphones, speakers, mixers, and amplifiers, all handled by our experienced technicians. From speeches to music, we ensure every moment is heard with clarity and precision, creating the perfect ambiance for your occasion.</p>
                                <p className='text-gray-500 mb-2'>Let us amplify the energy and excitement of your event. Book our sound services today and make your event truly memorable!</p>
                            </div>
                        </div>
