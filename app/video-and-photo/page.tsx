...
function VideographyAndPhotography() {
                ...
                <div className="flex md:flex-row flex-col justify-center items-start h-full">
                    ...
                    <div className="h-64 w-full relative rounded-xl">
                        ...
                        <h1 className="text-3xl font-bold">
                            Book Videography and Photography Services for Your Event
                        </h1>
                        <p className="text-sm mt-2">
                            Fill out the form on the right side to schedule your special
                            occasion
                        </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col justify-center items-start mt-4">
                        ...
                        Venus - Videography and Photography Services
                        </h2>
                        <p className="text-gray-500 mb-2">
                        Capture every special moment of your event with VENUS TENT
                        LIGHT AND SOUND’s professional photography and videography
                        services. Whether it’s a wedding, party, corporate event, or
                        celebration, our expert photographers and videographers ensure
                        every memory is beautifully preserved. From candid shots to
                        cinematic videos, we offer high-quality services tailored to
                        your event’s unique style.
                        </p>
                        <p className="text-gray-500 mb-2">
                        Serving Ranchi, Ramgarh, and surrounding areas, our team uses
                        state-of-the-art equipment to capture stunning visuals that
                        will last a lifetime. We focus on every detail to ensure your
                        event’s highlights are perfectly documented.
                        </p>
                        <p className="text-gray-500 mb-2">
                        Make your event unforgettable with photographs and videos that
                        tell your story. Book our photography and videography services
                    ...
                    className="p-4 border-2 border-gray-300 md:ml-4 md:mr-2 h-full rounded-xl"
                    >
...
export default VideographyAndPhotography;
