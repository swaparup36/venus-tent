                    ...
                    <div className='flex md:flex-row flex-col justify-center items-start h-full'>
                        ...
                        <div className='flex flex-col justify-start items-start w-full md:w-[65%] rounded-xl'>
                            <div className="h-64 w-full relative rounded-xl">
                                <Image
                                    src="/images/forms/lighting-hero.jpg"
                                ...
                                />
                                    ...
                                    <h1 className="text-3xl font-bold">Book Lightings for Your Event</h1>
                                    <p className="text-sm mt-2">Fill out the form on the right side to schedule your special occasion</p>
                                </div>
                            </div>

                            <div className='flex flex-col justify-center items-start mt-4'>
                                <h2 className='font-bold mb-4 text-xl'>Venus - Lighting Services</h2>
                                <p className='text-gray-500 mb-2'>Set the perfect mood for your event with VENUS TENT LIGHT AND SOUND’s professional lighting services. From soft, ambient lighting to dynamic, colorful displays, our expert team ensures that your event shines with elegance and style. Whether it’s a wedding, party, corporate event, or festival, we create customized lighting solutions tailored to your unique theme and venue.</p>
                                <p className='text-gray-500 mb-2'>Serving Ranchi, Ramgarh, and nearby areas, we use high-quality lighting equipment to provide a safe, reliable, and visually stunning experience. Our options include decorative chandeliers, LED lights, fairy lights, spotlights, and more to bring your vision to life.</p>
                                <p className='text-gray-500 mb-2'>Let us illuminate your special moments and create unforgettable memories. Book our lighting services today and transform your event into a dazzling celebration!</p>
                            </div>
                        </div>
