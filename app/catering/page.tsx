                    ...
                    <div className='flex md:flex-row flex-col justify-center items-start h-full'>
                        ...
                        <div className='flex flex-col justify-start items-start w-full md:w-[65%] rounded-xl'>
                            <div className="h-64 w-full relative rounded-xl">
                                <Image
                                    src="/images/forms/catering-hero.jpg"
                                ...
                                />
                                    ...
                                    <h1 className="text-3xl font-bold">Book Catering Services for Your Event</h1>
                                    <p className="text-sm mt-2">Fill out the form on the right side to schedule your special occasion</p>
                                </div>
                            </div>

                            <div className='flex flex-col justify-center items-start mt-4'>
                                <h2 className='font-bold mb-4 text-xl'>Venus - Catering Services</h2>
                                <p className='text-gray-500 mb-2'>Delight your guests with mouthwatering dishes from VENUS TENT LIGHT AND SOUND’s professional catering services. Whether it’s a wedding, party, corporate gathering, or festival, our catering team specializes in creating a menu tailored to your taste and event style. From traditional delicacies to contemporary cuisines, we ensure every bite leaves a lasting impression.</p>
                                <p className='text-gray-500 mb-2'>Serving Ranchi, Ramgarh, and nearby areas, we provide a complete catering solution, including preparation, presentation, and service. Our experienced chefs use high-quality ingredients to craft dishes that are not only delicious but also visually appealing, making your event a feast to remember.</p>
                                <p className='text-gray-500 mb-2'>Make your celebration truly special with our exceptional catering services. Book now and let us bring flavor and finesse to your event!</p>
                            </div>
                        </div>
