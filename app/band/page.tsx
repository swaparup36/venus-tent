                    ...
                    <div className='flex md:flex-row flex-col justify-center items-start h-full'>
                        ...
                        <div className='flex flex-col justify-start items-start w-full md:w-[65%] rounded-xl'>
                            <div className="h-64 w-full relative rounded-xl">
                                <Image
                                    src="/images/forms/band-hero.jpeg"
                                ...
                                />
                                    ...
                                    <h1 className="text-3xl font-bold">Book Band Services for Your Event</h1>
                                    <p className="text-sm mt-2">Fill out the form on the right side to schedule your special occasion</p>
                                </div>
                            </div>

                            <div className='flex flex-col justify-center items-start mt-4'>
                                <h2 className='font-bold mb-4 text-xl'>Venus - Band Services</h2>
                                <p className='text-gray-500 mb-2'>Bring your event to life with the lively sounds of VENUS TENT LIGHT AND SOUND’s band services. Whether you’re hosting a wedding, party, or corporate event, our talented band will set the perfect tone with energetic performances and a wide range of music styles. From traditional tunes to contemporary hits, our band ensures the music suits the vibe of your occasion and keeps your guests entertained throughout.</p>
                                <p className='text-gray-500 mb-2'>Serving Ranchi, Ramgarh, and nearby areas, we offer flexible packages to meet your event’s needs. Our experienced musicians provide high-quality live music that adds a special touch to any celebration.</p>
                                <p className='text-gray-500 mb-2'>Make your event memorable with live entertainment that keeps everyone on their feet. Book our band services today and let the music create unforgettable moments!</p>
                            </div>
                        </div>
