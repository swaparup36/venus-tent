                        ...
                        <div className='flex flex-col justify-start items-start w-full md:w-[65%] rounded-xl'>
                            <div className="h-64 w-full relative rounded-xl">
                                ...
                                />
                                    ...
                                    <h1 className="text-3xl font-bold">Book Flower Services for Your Event</h1>
                                    <p className="text-sm mt-2">Fill out the form on the right side to schedule your special occasion</p>
                                </div>
                            </div>

                            <div className='flex flex-col justify-center items-start mt-4'>
                                <h2 className='font-bold mb-4 text-xl'>Venus - Flower Services</h2>
                                <p className='text-gray-500 mb-2'>Add a touch of elegance and charm to your event with VENUS TENT LIGHT AND SOUND’s exquisite flower decoration services. Whether it’s a wedding, party, or corporate event, our floral arrangements are designed to enhance the ambiance and leave a lasting impression on your guests. From stunning centerpieces to elegant stage backdrops, we create custom floral designs that perfectly match your theme and style.</p>
                                <p className='text-gray-500 mb-2'>Serving Ranchi, Ramgarh, and surrounding areas, we source fresh, high-quality flowers to ensure vibrant and beautiful decorations. Our team of experts handles everything, from design to setup, ensuring a hassle-free experience for you.</p>
                                <p className='text-gray-500 mb-2'>Let us transform your venue into a breathtaking space filled with the beauty and fragrance of flowers. Book our flower decoration services today and make your event unforgettable!</p>
                            </div>
                        </div>
